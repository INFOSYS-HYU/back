...
const { getNotice, getNoticeById, getRecentNotice,createNotice, saveNoticeImages, updateNotice, deleteNotice } = require('../userDBC');
...
router.get('/recent', async (req, res) => {
  try {
    const notices = await getRecentNotice();
    res.json(notices);
  } catch (error) {
